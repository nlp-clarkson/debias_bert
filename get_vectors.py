...
APP = {
    'pronouns_input_dir': 'data/%s/pronouns' % BENCHMARK,
    'pronouns_output_dir': 'output/%s/pronouns' % BENCHMARK,
    'jobs_input_dir': 'data/%s/jobs' % BENCHMARK,
    'jobs_output_dir': 'output/%s/jobs' % BENCHMARK,
    'verbose': False
}
